...
const Subscribe = () => {
  return (
    <div>
      <div
        className="flex flex-col items-center justify-between gap-5 py-2 mt-15 shadow-2xl shadow-zinc-950
       transition-all duration-200 scrollbar-track-orange-500"
      >
